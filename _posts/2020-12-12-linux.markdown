...
image:
  path: /assets/images/linux/kernel-contributions-chart.png
  alt: Chart showing Linux kernel contributions by company over time — Red Hat, Google, Oracle, Apple, Microsoft
---
